...
public class StudentRepositoryTests {
    ...
    void test() {
        ...
        Takes t1 = Takes.builder().id(new TakesId(s1.getId(), clazz1.getId())).grade("B+").build();
        Takes t2 = Takes.builder().id(new TakesId(s1.getId(), clazz3.getId())).grade("A+").build();
        Takes t3 = Takes.builder().id(new TakesId(s1.getId(), clazz7.getId())).grade("A").build();
        Takes t4 = Takes.builder().id(new TakesId(s2.getId(), clazz2.getId())).grade("A").build();
        Takes t5 = Takes.builder().id(new TakesId(s2.getId(), clazz3.getId())).grade("B+").build();
        Takes t6 = Takes.builder().id(new TakesId(s2.getId(), clazz9.getId())).grade("C+").build();
        Takes t7 = Takes.builder().id(new TakesId(s3.getId(), clazz4.getId())).grade("B").build();
        Takes t8 = Takes.builder().id(new TakesId(s3.getId(), clazz6.getId())).grade("A+").build();
        Takes t9 = Takes.builder().id(new TakesId(s4.getId(), clazz2.getId())).grade("C+").build();
        Takes t10 = Takes.builder().id(new TakesId(s5.getId(), clazz2.getId())).grade("C").build();
        Takes t11 = Takes.builder().id(new TakesId(s5.getId(), clazz4.getId())).grade("B+").build();
        Takes t12 = Takes.builder().id(new TakesId(s5.getId(), clazz5.getId())).grade("A+").build();
